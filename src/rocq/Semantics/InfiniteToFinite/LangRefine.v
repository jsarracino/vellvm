...
Qed.
  ...
  Proof.
    ...
    -
      ...
      Lemma llvm_fmuladd_f64_agrees_success :
        forall args1 args2 d1,
          Forall2 dvalue_refine_strict args1 args2 ->
          IS1.LLVM.Intrinsics.llvm_fmuladd_f64 args1 = inr d1 ->
          exists d2,
            IS2.LLVM.Intrinsics.llvm_fmuladd_f64 args2 = inr d2 /\
              dvalue_refine_strict d1 d2.
      Proof.
        (* Try the following proof? *)
        intros args1 args2 s ARGS EXEC.
        destruct ARGS; cbn in *; try congruence.
        destruct x;
          try
        ...
        unfold_dvalue_refine_strict_in H; inv H.
        unfold_dvalue_refine_strict_in H0; inv H0.
        unfold_dvalue_refine_strict_in H1; inv H1.

        destruct ARGS; cbn in *; try inv EXEC.
      ...
      Lemma llvm_fmuladd_f64_agrees_fail :
        forall args1 args2 s,
          Forall2 dvalue_refine_strict args1 args2 ->
          IS1.LLVM.Intrinsics.llvm_fmuladd_f64 args1 = inl s ->
          IS2.LLVM.Intrinsics.llvm_fmuladd_f64 args2 = inl s.
      Proof.
        intros args1 args2 s ARGS EXEC.
        destruct ARGS; cbn in *; try congruence.
        destruct x;
      ...
      all:
        try solve
          ...
          |
            ...
            rewrite Heqs0 in CONTRA; inv CONTRA
          |
            pose proof (llvm_fmuladd_f64_agrees_fail _ _ _ REFARGS Heqs) as CONTRA;
            rewrite Heqs0 in CONTRA; inv CONTRA
          ].
      ...
      all:
        try solve
          ...
          | pose proof (llvm_ushl_sat_64_agrees_success _ _ _ REFARGS Heqs) as [d2 [CONTRA REF]];
            rewrite Heqs0 in CONTRA; inv CONTRA; eauto using orutt_Ret
          | pose proof (llvm_fmuladd_f64_agrees_success _ _ _ REFARGS Heqs) as [d2 [CONTRA REF]];
            rewrite Heqs0 in CONTRA; inv CONTRA; eauto using orutt_Ret
          ].
